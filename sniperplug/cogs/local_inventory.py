...
RETAILER_CHOICES = [
    app_commands.Choice(name="Home Depot", value="home_depot"),
...
class LocalInventoryCog(commands.Cog):
    ...
    @app_commands.describe(
        retailer="Retailer to check.",
        sku="Optional store SKU / item ID / internet number if you know it.",
    ...
    @app_commands.choices(retailer=RETAILER_CHOICES)
    @app_commands.checks.has_permissions(manage_guild=True)
    async def local_check(
        self,
        interaction: discord.Interaction,
        retailer: app_commands.Choice[str],
        sku: str | None = None,
        ...
        retailer_key = normalize_retailer_key(retailer.value)
