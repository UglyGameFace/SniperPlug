...
class HPWatcherSettings:
    ...
    product_page_batch_size: int = 12
    offer_batch_size: int = 40
    ...
    run_once: bool = False
    user_agent: str = "SniperPlug-HP-Watcher/1.0 (+https://sniperplug.com)"
    ...
    def from_env(cls) -> "HPWatcherSettings":
        ...
        return cls(
            ...
            loop_seconds=_bounded_int("HP_WATCHER_LOOP_SECONDS", 30, minimum=10, maximum=3600),
            sitemap_batch_size=_bounded_int("HP_SITEMAP_BATCH_SIZE", 2, minimum=1, maximum=20),
            product_page_batch_size=_bounded_int("HP_PRODUCT_PAGE_BATCH_SIZE", 12, minimum=1, maximum=100),
            offer_batch_size=_bounded_int("HP_OFFER_BATCH_SIZE", 40, minimum=1, maximum=100),
            ...
            user_agent=os.getenv("HP_WATCHER_USER_AGENT", "SniperPlug-HP-Watcher/1.0 (+https://sniperplug.com)").strip(),
        )
