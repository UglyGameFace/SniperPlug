...
def score_candidate(candidate: SourceCandidate) -> ScoutLead | None:
    ...
    combined_text = f"{product_text} {route_text}"
    ...
    # A brand-specific search route like "dolce perfume clearance" should not
    # make Kenneth Cole look like a Dolce product. Route terms explain where the
    # product came from; only the product title/metadata can earn brand credit.
