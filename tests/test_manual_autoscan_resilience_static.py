...
def test_bot_uses_resilient_runner():
    assert "from sniperplug.cogs.resilient_auto_scan_runner import AutoScanRunnerCog" in BOT
    assert "from sniperplug.cogs.native_auto_scan_runner import AutoScanRunnerCog" not in BOT
